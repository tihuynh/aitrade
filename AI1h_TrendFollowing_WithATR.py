...
if TESTNET_MODE:
    ...
    testnet = True
    model_file = "models/testnet/ai1h_model.keras"  # Model riêng cho Testnet
    data_file = "data/testnet/data1h.json"  # Dữ liệu riêng cho Testnet
else:
    API_KEY = "Hm5gG0HKbm5MDo5bpo"
    API_SECRET = "D6iP8YwCisA8pUylvh6916rnvWxoyKQnq1jp"
    testnet = False
    model_file = "models/real/ai1h_model.keras"  # Model riêng cho tài khoản thật
    data_file = "data/real/data1h.json"  # Dữ liệu riêng cho tài khoản thật
...
def fetch_data_with_indicators(symbol="BTCUSDT", timeframe="60", limit=2000, retry_attempts=5):
